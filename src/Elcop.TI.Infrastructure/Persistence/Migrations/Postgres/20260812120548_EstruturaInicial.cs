        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CentroCusto = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contato = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Nome = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    Unidade = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnderecoIp = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    NomeCompleto = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailPessoal = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    ...
                    Cargo = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    GestorImediato = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Patrimonio = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ...
                    NumeroLinha = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    Operadora = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    EnderecoMac = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ...
                    NotaFiscal = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    GarantiaAte = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Contrato = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    Processador = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    MemoriaRam = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    Armazenamento = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    SistemaOperacional = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    Hostname = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    Tamanho = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    Acessorios = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Observacoes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    FotoUrl = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    CriadoEm = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CriadoPor = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Responsavel = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    ...
                    Solucao = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    CriadoEm = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CriadoPor = table.Column<string>(type: "text", nullable: true),
                    AtualizadoEm = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AtualizadoPor = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponsavelEntrega = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    LocalEntrega = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    ObservacoesRetirada = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    TermoAssinado = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    AcessoriosDevolvidos = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ResponsavelRecebimento = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    ObservacoesDevolucao = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Autor = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
